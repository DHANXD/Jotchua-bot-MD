...
`.trim();
    ...
    console.log(error)
    throw '_𝐄𝐑𝐑𝐎𝐑, 𝐕𝐔𝐄𝐋𝐕𝐀 𝐀 𝐈𝐍𝐓𝐄𝐍𝐓𝐀𝐑𝐋𝐎_';
  }
};
 ...
 Enviando ${additionalText}, aguarde un momento．．．`.trim();
  ...
  try {
    ...
    try {
      ...
      await conn.sendMessage(m.chat, {video: {url: mediaa.result}, fileName: `error.mp4`, caption: `𝐓𝐡𝐞 𝐌𝐲𝐬𝐭𝐢𝐜 - 𝐁𝐨𝐭`, thumbnail: mediaa.thumb, mimetype: 'video/mp4'}, {quoted: m});
    } catch {
      try {
